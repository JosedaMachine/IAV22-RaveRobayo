...
public class Cypher : InfoReceiver
{
    ...
    void Update()
    {
        ...
        if (clearingHooka)
        {
            ...
            Vector3 hookaArrowSpot = trapSpots[(int)arrows.Hooka].transform.position;
            ...
            if(dist.magnitude < offsetToPoints + lookingOffset) transform.LookAt(trapSpots[(int)arrows.Hooka].transform);
        ...
        else if (clearingLong)
        {
            ...
            Vector3 longArrowSpot = trapSpots[(int)arrows.Long].transform.position;
            ...
            if (dist.magnitude < offsetToPoints + lookingOffset) transform.LookAt(trapSpots[(int)arrows.Long].transform);
        ...
        else if (clearingSite)
        {
            ...
            if (distToLong.magnitude < distToHooka.magnitude)
            {
                ...
                Vector3 siteArrowSpot = trapSpots[(int)arrows.Site].transform.position;
                ...
                if (dist.magnitude < offsetToPoints + lookingOffset) transform.LookAt(trapSpots[(int)arrows.Site].transform);
    ...
    //    GameObject arr = Instantiate(trap,target, Quaternion.identity);
